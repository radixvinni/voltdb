...
This fork aims to porting VoltDB Community edition to Windows newer than XP. I used MSYS2. It will build on MinGW too, but you will need some port for ucontext 
